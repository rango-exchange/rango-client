...
type UpdatedMetaResponse = Omit<MetaResponse, 'blockchains'> & {
  ...
  create<MetaState>()((set) => ({
    ...
    fetchMeta: async () => {
      try {
        ...
        (response.blockchains as ProviderMeta[]) = normalizeMetaData(
        ...
        set({
          meta: {
            ...response,
            blockchains: response.blockchains as ProviderMeta[],
          },
