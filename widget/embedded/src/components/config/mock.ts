import { TokenMeta, BlockchainMeta, LiquiditySource } from '@rangodev/ui/dist/types/meta';
...
export const Wallets = [
  {
    title: 'ArgentX',
    logo: 'https://app.rango.exchange/wallets/argentx.svg',
    type: WalletType.ARGENTX,
  },
  {
    title: 'Binance',
    logo: 'https://app.rango.exchange/wallets/binance.svg',
    type: WalletType.BINANCE_CHAIN,
  },
  {
    title: 'Brave',
    logo: 'https://app.rango.exchange/wallets/brave.png',
    type: WalletType.BRAVE,
  },
  {
    title: 'Clover',
    logo: 'https://app.rango.exchange/wallets/clover.jpeg',
    type: WalletType.CLOVER,
  },
  {
    title: 'Coin98',
    logo: 'https://app.rango.exchange/wallets/coin98.svg',
    type: WalletType.COIN98,
  },
  {
    title: 'Coinbase',
    logo: 'https://app.rango.exchange/wallets/coinbase.svg',
    type: WalletType.COINBASE,
  },
  {
    title: 'Cosmostation',
    logo: 'https://app.rango.exchange/wallets/cosmostation.png',
  ...
  {
    title: 'Phantom',
    logo: 'https://app.rango.exchange/wallets/phantom.svg',
    type: WalletType.PHANTOM,
  },
  {
    title: 'SafePal',
    logo: 'https://app.rango.exchange/wallets/safepal.png',
    type: WalletType.SAFEPAL,
  },
  {
    title: 'TronLink',
    logo: 'https://app.rango.exchange/wallets/tron-link.png',
    type: WalletType.TRON_LINK,
  },
  {
    title: 'Trust Wallet',
    logo: 'https://app.rango.exchange/wallets/trust.png',
    type: WalletType.TRUST_WALLET,
  },
  {
    title: 'WalletConnect',
    logo: 'https://app.rango.exchange/wallets/walletconnect.svg',
    type: WalletType.WALLET_CONNECT,
  },
  {
    title: 'XDefi',
    logo: 'https://app.rango.exchange/wallets/xdefi.jpg',
