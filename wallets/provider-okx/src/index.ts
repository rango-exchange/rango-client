...
import { getSolanaAccounts, okx_instance, OKX_WALLET_SUPPORTED_CHAINS } from './helpers';
...
export const getWalletInfo: (allBlockChains: ProviderMeta[]) => WalletInfo = (allBlockChains) => ({
  ...
  installLink: {
    ...
    BRAVE: 'https://chrome.google.com/webstore/detail/okx-wallet/mcohilncbfahbmgdjkbpemcciiolgcge',
