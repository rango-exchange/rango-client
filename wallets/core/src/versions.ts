...
import type { LegacyProviderInterface } from './legacy/types';

export type VLegacy = LegacyProviderInterface;
export type V1 = Provider;

type VersionedVLegacy = ['0.0.0', VLegacy];
type VersionedV1 = ['1.0.0', V1];
