...
Coinbase Wallet returns nothing meaningful when the user rejects the **Solana** connection request, so a rejection **can't be told apart** from other connection failures and is reported as `unknown`.
