...
/**
 * Noir reports a rejected connect request only in the error message, so the
 * standard rejection code is attached here.
 */
function convertNoirRejectionError(_context: unknown, error: unknown): unknown {
...
export const utxoHooks = { convertNoirRejectionError };
