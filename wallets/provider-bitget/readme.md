...
#### ⚠️ Connect Rejection (Tron)
When the user rejects a Tron connection, Bitget returns nothing meaningful, so the rejection **can't be told apart from a real failure**. It's reported as a regular connection error.
