...
export enum SwapActionTypes {
  ...
  CHECK_EVM_APPROVE = 'CHECK_EVM_APPROVE',
  CHECK_EVM_APPROVE_TRANSACTION_STATUS = 'CHECK_EVM_APPROVE_TRANSACTION_STATUS',
  CHECK_TRON_APPROVE = 'CHECK_TRON_APPROVE',
  CHECK_TRON_APPROVE_TRANSACTION_STATUS = 'CHECK_TRON_APPROVE_TRANSACTION_STATUS',
